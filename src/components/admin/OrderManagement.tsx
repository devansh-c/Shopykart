    ...
    return (
      <div id={`receipt-content-customer-${orderData.id}`} className="bg-white text-black p-8 font-mono text-[10px] uppercase leading-tight w-[380px] border border-gray-100 shadow-xl">
        ...
        <div className="space-y-1.5">
          <div className="flex justify-between"><span>ORDER NO:</span><span className="font-black">#{orderData.customerOrderNumber || '...'}</span></div>
          ...
          <div className="flex justify-between text-primary font-black"><span>DELIVERY OTP:</span><span>{orderData.deliveryOTP || '000000'}</span></div>
        </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                       ...
                       <div className="bg-blue-50 px-3 py-1 rounded-lg border border-blue-100 flex items-center gap-1.5">
                          ...
                          <span className="text-[10px] font-black text-blue-800 uppercase tracking-tight">OTP: {order.deliveryOTP}</span>
                       </div>
                    </div>
