      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className={cn(
          ...
          <div className="px-8 py-4 border border-[#C5A021]/30 rounded-[2rem] bg-black/40 backdrop-blur-md shadow-[0_0_40px_rgba(197,160,33,0.15)] flex flex-col items-center">
            ...
            <span className="text-[8px] font-black uppercase tracking-[0.4em] text-white/40 mt-2">
              QUALITY FIRST
            </span>
          </div>
          <p className="text-center mt-6 text-[8px] text-[#C5A021] font-black uppercase tracking-[0.3em] opacity-70">
            Premium Food Delivery
          </p>
        </div>
      </div>

      <div className="absolute bottom-20 w-32 h-[1px] bg-white/5 overflow-hidden">
