 ...
 * Removed Places API (New) to prevent resolution errors.
 */
              ...
              <div className="flex items-center gap-3">
                 ...
                 <div className="flex-1 min-w-0">
                   <p className="text-[11px] font-black text-gray-900 line-clamp-1 uppercase tracking-tight italic">
                      {isResolving ? 'IDENTIFYING...' : resolvedAddress || 'PIN YOUR DOORSTEP'}
                   </p>
                   <p className="text-[7px] font-black text-muted-foreground uppercase tracking-widest mt-0.5">HIGH-PRECISION GEO-LOCATION</p>
                 </div>
              </div>
           </div>
