...
/**
 * @fileOverview Handles zero-OTP quick access for customers.
 * Collects profile details and signs in anonymously.
 */
    ...
    <div className="fixed inset-0 z-[200] bg-[#0B0B0B] flex flex-col p-8 animate-in fade-in duration-300 overflow-y-auto no-scrollbar pointer-events-auto">
      ...
      <div className="mt-auto text-center pb-10">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-[7px] font-black text-white/5 uppercase tracking-widest">ShopyKart Private Limited • Guaranteed Service</p>
        </div>
      </div>
    </div>
  );
