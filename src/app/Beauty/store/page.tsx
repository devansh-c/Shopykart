                       ...
                       <div className="bg-[#0B0B0B] p-8 rounded-[2.5rem] text-white shadow-2xl border border-white/5 relative overflow-hidden">
                          <div className="relative z-10 space-y-4">
                             <div className="flex items-center gap-3 mb-2">
                                <div className="bg-rose-500/20 p-2 rounded-xl border border-rose-500/20"><ShieldCheck className="h-5 w-5 text-rose-500" /></div>
                                <span className="text-xs font-black uppercase italic tracking-widest text-rose-500">Verified Bank Details</span>
                             </div>
                             <div className="space-y-4">
                                <div>
                                ...
                                <div>
                                   ...
                                   <p className="text-sm font-black tracking-widest text-rose-500">{vendorProfile.ifscCode}</p>
                                </div>
                             </div>
         ...
         <DialogContent className="rounded-t-[3rem] sm:rounded-[3rem] max-w-md p-0 overflow-hidden border-none shadow-2xl bg-white focus:outline-none">
            ...
            <div className="p-8 space-y-6 pt-2">
                  ...
                  <div className="space-y-1.5">
                     ...
                     <div className="relative">
                        ...
                        <Input 
                          ...
                          className="h-14 pl-12 rounded-2xl bg-gray-50 border-none font-black tracking-widest text-rose-600"
                        />
                     </div>
                  </div>
               </div>
               ...
               <Button 
                ...
                className="w-full h-18 bg-[#0B0B0B] hover:bg-rose-600 text-white rounded-[2rem] font-black uppercase italic shadow-xl text-lg transition-all"
               >
