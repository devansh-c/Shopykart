...
export default function BeautyDashboard() {
  ...
  const handleDownload = async (order: any) => {
    ...
    try {
      ...
      link.download = `Beauty_Bill_${order.orderDisplayId || order.id.slice(-5)}.jpg`;
      link.href = dataUrl;
      link.click();
      toast({ title: "Saved!" });
                      ...
                      <Dialog>
                        ...
                        <DialogContent className="rounded-[2.5rem] max-w-[340px] p-4 bg-white">
                          ...
                          <div className="flex gap-2 mt-4">
                             ...
                             <Button onClick={() => handleDownload(o)} disabled={downloadingId === o.id} className="flex-1 bg-rose-600 h-12 rounded-xl text-white font-black text-[10px] uppercase">
