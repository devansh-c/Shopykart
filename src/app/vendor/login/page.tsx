...
import { Store, Lock, Loader2, Fingerprint, HeartPulse, Sparkles, Apple, ChevronLeft } from 'lucide-react';
...
function LoginPageContent() {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      // If storeId is entered instead of email, try to find the email
