    ...
    <div className="min-h-screen bg-[#F9FAFB] flex flex-col max-lg mx-auto shadow-2xl relative">
      ...
      <header className="bg-white px-4 py-4 flex items-center justify-between border-b sticky top-0 z-50">
         <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-sm font-black italic uppercase">{vendorProfile?.storeName || 'Business Hub'}</h1>
         ...
         {activeMainTab === 'orders' ? (
                    ...
                    <DialogContent className="rounded-[2.5rem] max-w-sm max-h-[90vh] overflow-y-auto no-scrollbar">
                       ...
                       <div className="space-y-4 pt-4">
                          ...
                          <div className="space-y-1">
                             ...
                             <Textarea placeholder="Details (Ingredients, usage, etc.)" value={newProduct.description} onChange={e => setNewProduct({...newProduct, description: e.target.value})} className="rounded-xl bg-muted/10 h-24 font-medium text-sm" />
                          </div>
           ...
           <div className="p-4 space-y-6 animate-in fade-in duration-500">
              <div className="bg-white p-6 rounded-[2.5rem] border border-border/50 shadow-sm text-center">
                 ...
                 <h2 className="text-2xl font-black italic uppercase tracking-tighter">{vendorProfile?.storeName || 'Business Portal'}</h2>
              ...
              <Button onClick={() => { localStorage.removeItem('shopykart_session_active'); signOut(auth!); }} className="w-full h-14 bg-red-50 text-red-500 hover:bg-red-100 rounded-2xl font-black uppercase italic text-xs tracking-widest border-none">EXIT DASHBOARD</Button>
           </div>
         )}
      </main>
