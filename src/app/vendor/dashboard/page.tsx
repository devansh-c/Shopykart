...
export default function VendorDashboard() {
  ...
  // Use state to track if we should even check auth yet
  ...
  // If auth is loading, we still show the shell to keep "no loading" feel
  return (
    <div className="min-h-screen bg-[#F9FAFB] pb-24 text-black">
      ...
      <main className="p-6">
        {!user && !hasCheckedAuth ? (
          <div className="py-20 text-center text-muted-foreground text-sm font-bold uppercase tracking-widest">Initialising...</div>
        ) : (
          <>
            {activeTab === 'orders' && (
