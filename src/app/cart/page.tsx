...
import { doc, setDoc, serverTimestamp, collection, increment, query, where, getDocs, addDoc, getCountFromServer } from 'firebase/firestore';
...
function CartContent() {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const customerOrderNumber = countSnapshot.data().count + 1;

      // Delivery OTP (Customer to Delivery Boy)
      const deliveryOTP = Math.floor(100000 + Math.random() * 900000).toString();
      // Pickup OTP (Vendor to Delivery Boy)
